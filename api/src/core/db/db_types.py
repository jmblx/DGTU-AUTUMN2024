...
# )]
achievement_fk = Annotated[int, mapped_column(ForeignKey("achievement.id"), nullable=True)]
event_fk = Annotated[int, mapped_column(ForeignKey("event.id"), nullable=True)]
reward_fk = Annotated[int, mapped_column(ForeignKey("reward.id"), nullable=True)]
purchase_fk = Annotated[int, mapped_column(ForeignKey("purchase.id"), nullable=True)]
user_fk = Annotated[str, mapped_column(ForeignKey("user.id"), nullable=True)]
not_null_user_fk = Annotated[str, mapped_column(ForeignKey("user.id"), nullable=False)]
