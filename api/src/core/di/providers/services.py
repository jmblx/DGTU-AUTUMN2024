...
from infrastructure.services.reward.reward_service_impl import RewardServiceImpl
...
class ServiceProvider(Provider):
    ...
    reward_service = provide(RewardServiceImpl, scope=Scope.REQUEST, provides=RewardServiceInterface)
